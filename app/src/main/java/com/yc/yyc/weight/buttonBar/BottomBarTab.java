package com.yc.yyc.weight.buttonBar;
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_gray));
    ...
    public void setSelected(boolean selected) {
        ...
        switch (mTabPosition){
            case 0:
                mIcon.setImageResource(selected? R.mipmap.ic_launcher : R.mipmap.ic_launcher);
                break;
            case 1:
                mIcon.setImageResource(selected? R.mipmap.ic_launcher : R.mipmap.ic_launcher);
                break;
...
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.red_EF402C));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.red_FF5A60));
        } else {
